...
import { countries } from './countries-consts';
                ...
                >
                    ...
                    <div className='mt-8'>
                        ...
                        <div>
                            ...
                            />
                            <Text
                                text=' Tell us what you need help with — be as detailed as you like.'
                                variant='lg'
                        ...
                        />
                        <label className='text-[#101828] ff_geret text-base'>
                            File
                        </label>
                        <CustomFileUpload
                            fileTypeDescription=' Supported format: PNG, PDF, JPEG, Doc'
                            onFileChange={() => alert('file uploaded')}
                            label='Drag & Drop file or Browse'
                        />
                    </div>
